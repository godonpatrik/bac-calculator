            ...
            <section className="bg-gray-800 rounded-lg p-6 mb-4">
              ...
              <div className="text-gray-300 text-sm space-y-2 text-left">
                <p>
                  ...
                  your weight, and gender. The calculator uses the Widmark
                  formula to provide accurate BAC estimations and shows you when
                  you'll likely be sober.
                </p>
                <p>
            ...
            <section className="bg-gray-800 rounded-lg p-6 mb-4">
              ...
              <div className="text-gray-300 text-sm space-y-2 text-left">
                <p>
                  ...
                  blood. For example, a BAC of 0.08% means there are 0.08 grams
                ...
                <p>
                  ...
                  with slightly impaired judgment. At 0.05-0.08%, coordination
                  and reaction time are noticeably affected. At 0.08% and above
                  (the legal limit in most jurisdictions), driving ability is
                ...
                <p>
                  ...
                  consumed, your body weight, gender (women typically have
                  higher BAC than men after consuming the same amount), rate of
                ...
                <p>
                  ...
                  0.015-0.017% per hour. This means it takes time for your BAC
                  to return to zero - you cannot speed up this process with
            ...
            <section className="bg-gray-800 rounded-lg p-6 mb-4">
              ...
              <div className="text-gray-300 text-sm space-y-2 text-left">
                ...
                <p>
                  ...
                  / (Body weight in grams × r)) - (Metabolism rate × Time).
                  Where 'r' is the gender constant (0.68 for men, 0.55 for
                  women), reflecting differences in body water content and
                ...
                <ol className="list-decimal list-inside ml-4 space-y-1">
                  <li>
                    ...
                    alcohol content by multiplying the drink volume by its
                    alcohol percentage and the density of alcohol (0.789 g/ml).
                  </li>
                  <li>
                    <strong>Total Body Water:</strong> Your body weight is
                    multiplied by the gender constant to estimate total body
                    water where alcohol distributes.
                  </li>
                  <li>
                ...
                <p>
                  ...
                  provides an estimate based on average values. Individual
                  results vary due to metabolism differences, food consumption,
            ...
            <section className="bg-gray-800 rounded-lg p-6 mb-4">
              ...
              <div className="text-gray-300 text-sm space-y-2 text-left">
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  ...
                  <li>
                    <strong>Planning:</strong> Allows you to estimate when
                    you'll be sober again, helping you plan safe transportation
                    or when it's safe to drive.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Responsibility:</strong> Encourages conscious
                    drinking decisions and helps you stay within safe limits.
                  </li>
                  <li>
                    <strong>Prevention:</strong> May prevent dangerous
                    situations by showing you when you're approaching or
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>
                    <strong>Any BAC Above 0.00%:</strong> The safest policy is
                    to never drive after consuming any alcohol, even if below
                    the legal limit.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    medications (prescription, over-the-counter, or
                    recreational) can cause unexpected impairment.
                  </li>
                </ul>
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  ...
                  <li>
                    <strong>Pace Yourself:</strong> Limit yourself to one
                    standard drink per hour to allow your body time to
                    metabolize alcohol.
                  </li>
                  <li>
                ...
                <p className="pt-2 font-semibold text-yellow-400">
                  ...
                  decide if you can drive. The only safe choice after drinking
                  is to not drive at all. Drunk driving kills - choose
                  alternative transportation every time.
                </p>
              </div>
            </section>
            ...
            <section className="bg-gray-800 rounded-lg p-6 mb-4">
              ...
              <div className="text-gray-300 text-sm space-y-2 text-left">
                <ol className="list-decimal list-inside ml-4 space-y-2">
                  ...
                  <li>
                    <strong>Add your drinks:</strong> Select from predefined
                    drink types (beer, wine, spirits) or enter a custom drink
                    with its volume and alcohol percentage.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>See your sober time:</strong> The calculator
                    estimates when your BAC will reach zero based on average
                    metabolism rates.
                  </li>
                </ol>
              </div>

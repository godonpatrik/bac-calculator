    ...
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <div>
        ...
        <input
          ...
          required
          className="w-full max-w-full px-2 py-1.5 text-sm bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
